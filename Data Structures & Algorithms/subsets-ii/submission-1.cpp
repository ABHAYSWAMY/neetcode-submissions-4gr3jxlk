...
public:
    void backtrack(int i, vector<int>& nums, vector<int>& curr, vector<vector<int>>& ans){
        ...
        // reject a number once, then I wont let you take same number again
        //the branch which rejects current number should not take up the same number, rather it shld go for next number
